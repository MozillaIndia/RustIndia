//-- #########################
//-- Task: Command line argument to implement wget in Rust
//-- Author: Vigneshwer.D
//-- Version: 1.0.0
//-- Date: 11 sept 2017
//-- ######################### 

// External crate used for creating the command line argument 
extern crate clap;
extern crate console;
extern crate reqwest;
extern crate indicatif;

// Modules required from clap crate 
use clap::{Arg, App};
// std modules
use std::fs;
use std::fs::File;
...
// Coloring the text in the console to measure progress 
fn create_progress_bar(quiet_mode: bool, msg: &str, length: Option<u64>) -> ProgressBar {
    let bar = match quiet_mode {
        true => ProgressBar::hidden(),
        false => {
